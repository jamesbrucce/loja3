...
namespace LojaCL
{
    public partial class FrmVenda : Form
    {
        ...
        //SqlConnection con = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\Master\\source\\repos\\LojaChingLing-master\\DbLoja.mdf;Integrated Security=True;Connect Timeout=30");
        public FrmVenda()
        {
            InitializeComponent();
        }
